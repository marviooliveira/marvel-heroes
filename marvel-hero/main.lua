...
-------------------------carrega as imagens de empate e vitorias-----------------------
	...
	spidercampeaoimg=love.graphics.newImage("img/spidercampeao.png")
...
if ball.b:getY()<45 then   --45     --------------- em cima-----------------
	ball.b:applyForce(0,1000)
end
if ball.b:getY()>555 then      --555  --------------- em cima-----------------
	ball.b:applyForce(0,-1000)
end
...
-----------------------------PARA O spider----------------------------
	...
	elseif love.keyboard.isDown("left") and love.keyboard.isDown("down") and startcenario1==true then
		spider.b:setLinearVelocity(-400,400) --diagonal
...
function love.keyreleased(key)
	if key == "p" and startcenario1 then
		pausar=not pausar
	end
end
